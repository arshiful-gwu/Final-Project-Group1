...
import os
os.system("sudo pip install tensorboard")
os.system("sudo pip install tensorboardX")
...
print("baselineModel.py: started")

torch.backends.cudnn.deterministic = True
torch.manual_seed(999)

writer_train = SummaryWriter('runsBM/models')
...
torch.save(cnn.state_dict(), 'baselineModel.pkl')
print("baselineModel.py: completed")