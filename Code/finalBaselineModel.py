...
print("finalBaselineModel.py: started")
...
accOfNet=(100*(correct//total))

print("Accuracy of the network on the validation set : "+str(accOfNet))
...
print("finalBaselineModel.py: completed")
